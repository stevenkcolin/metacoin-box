...
var SyntheticToken_json_1 = __importDefault(require("./abi/SyntheticToken.json"));
var TestnetERC20_json_1 = __importDefault(require("./abi/TestnetERC20.json"));
...
var contracts = {
    ...
    syntheticToken: {
        abi: SyntheticToken_json_1.default,
    },
    testnetERC20: {
        abi: TestnetERC20_json_1.default,
    },
    voting: {
